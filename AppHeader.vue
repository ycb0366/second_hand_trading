...
<!--                <img src="image/bg2.jpg" alt="" style="width:20px; position: relative; top:5px; margin-right: 5px">-->
              <router-link to="/">
                <img src='@/assets/image/logo2.png' style='height: 10vb' alt="校园二手物品交易平台">
              </router-link>
            ...
            <div class="search-container"  >
                <el-input placeholder="搜物品..." v-model="searchValue" prefix-icon="el-icon-search" @keyup.enter.native="searchIdle">
                    <el-button slot="append" icon="el-icon-search" circle @click="searchIdle" ></el-button>
                </el-input>

            </div>
            <el-button type="primary" icon="el-icon-plus"  @click="toRelease" style='border-radius: 100vb'>物品发布</el-button>
            <el-button type="primary" icon="el-icon-chat-dot-round" @click="toMessage" style='border-radius: 100vb'>消息</el-button>
